...
const anotherString = gameName.slice(-13, 4) // Starts froma  negative valu which is converted to gamename.length - 13 => starting index
// console.log(anotherString)

const newStringone = "  Hello World! "
console.log(newStringone.trim()) // removing empty spaces from the string

// replace() method replaces a character of a string

console.log(newStringone.replace("World", "Mahfuz"));

console.log(newStringone.includes("M")); // returned false because original string was not changed in previous operation

console.log(newStringone.split(" ")); //splits the string based on the delimiter provided inside method and returns an array of the values
